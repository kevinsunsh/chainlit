...
class ChainlitEmitter:
    ...
    @property
    def backend(self) -> Union[BaseBackend, None]:
        """Get the 'backend' property from the session."""
        return self._get_session_property("backend", raise_error=False)
        ...
        try:
            ...
            if self.backend and res:
                ...
                if spec.type == "text":
                    ...
                    await self.backend.create_message(res_msg)
                elif spec.type == "file":
